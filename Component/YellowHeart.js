...
import styles from "../styles/YellowHeart.module.scss";
      ...
      >
        ...
        >
          ...
          <div className={_styles.description}>
            ...
            <ul>
              <li>
                Implement web portal UI component by providing more significant
              ...
              <li>
                ...
                configuration modules. Collaboration and communication help move
                things along faster.
              </li>
            </ul>
            <p>Technologies used: JavaScript, ReactJs, NextJs, HTML5, SCSS</p>
            <p>
